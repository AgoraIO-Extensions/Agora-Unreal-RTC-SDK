	...
	if (VideoViewMap.Contains(Key))
	{
		...
		*/
		...
		/*
			...
			RotatedWidth = max((Width * cos(��) - Height * sin(��)), (Width * cos(��)), 0) - min((0), (0), (Width * cos(��) - Height * sin(��)))
			RotatedHeight = max((Width * sin(��) + Height * cos(��)), (Height * cos(��)), 0) - min((0), (0), (Width * sin(��) + Height * cos(��)))
			RotatedWidth = Width * cos(��) - Height * sin(��)
			RotatedHeight = Width * sin(��) + Height * cos(��)
		*/
