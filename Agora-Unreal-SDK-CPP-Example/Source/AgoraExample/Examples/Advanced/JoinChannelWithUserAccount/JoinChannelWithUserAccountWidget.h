...
#include "JoinChannelWithUserAccountWidget.generated.h"
 ...
 */
UCLASS()
class AGORAEXAMPLE_API UJoinChannelWithUserAccountWidget : public UBaseAgoraUserWidget
{
	GENERATED_BODY()
...
public:
	...
	public:
		...
		FUserRtcEventHandlerEx(UJoinChannelWithUserAccountWidget* InVideoWidget) : WidgetPtr(InVideoWidget) {};
...
#pragma endregion
	...
	private:
		...
		TWeakObjectPtr<UJoinChannelWithUserAccountWidget> WidgetPtr;
	};
...
#pragma region UI
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, meta = (BindWidget))
	UButton* Btn_GetUserInfo = nullptr;
