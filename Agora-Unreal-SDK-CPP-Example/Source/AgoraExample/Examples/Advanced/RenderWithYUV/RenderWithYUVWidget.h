...
#include "RenderWithYUVWidget.generated.h"
 ...
 */
UCLASS()
class AGORAEXAMPLE_API URenderWithYUVWidget : public UBaseAgoraUserWidget
{
	GENERATED_BODY()
...
public:
	...
	public:
		...
		FUserRtcEventHandlerEx(URenderWithYUVWidget* InVideoWidget) : WidgetPtr(InVideoWidget) {};
...
#pragma endregion
	...
	private:
		...
		TWeakObjectPtr<URenderWithYUVWidget> WidgetPtr;
	};
	...
	public:
		...
		FUserVideoFrameObserver(URenderWithYUVWidget* InVideoWidget) : WidgetPtr(InVideoWidget) {
			//LogSet.Empty();
		};
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		UMaterial* MatYUV = nullptr;

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		UTextureRenderTarget2D* RT_Output = nullptr;

	void MakeVideoViewForYUVV();

	void ReleaseVideoViewForYUVV();

	void RenderRawData(agora::media::base::VideoFrame& videoFrame);
private:
	UDraggableVideoViewWidget* YUVVideoRenderView = nullptr;
#pragma endregion
