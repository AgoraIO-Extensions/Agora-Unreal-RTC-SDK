...
#include "ContentInspectWidget.generated.h"
 ...
 */
UCLASS()
class AGORAEXAMPLE_API UContentInspectWidget : public UBaseAgoraUserWidget
{
	GENERATED_BODY()
...
public:
	...
	public:
		...
		FUserRtcEventHandlerEx(UContentInspectWidget* InVideoWidget) : WidgetPtr(InVideoWidget) {};
...
#pragma endregion
	...
	private:
		...
		TWeakObjectPtr<UContentInspectWidget> WidgetPtr;
	};
