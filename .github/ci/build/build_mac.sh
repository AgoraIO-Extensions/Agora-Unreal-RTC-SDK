...
mv "$CI_DIR"/temp/"$PLUGIN_NAME".zip  "$CI_DIR"/temp/Agora_Unreal_RTC_SDK_${SDK_VERSION}_${profile}_${build_time}_${BUILD_NUMBER}.zip

cp "$CI_DIR"/temp/Agora_Unreal_RTC_SDK_${SDK_VERSION}_${profile}_${build_time}_${BUILD_NUMBER}.zip "$WORKSPACE" || exit 1
