	...
	namespace rtc
	{
		namespace ue
		{
			...
			public:
				...
				//virtual int enableVirtualBackground(bool enabled, VirtualBackgroundSource backgroundSource) override;
				...
				//virtual int startAudioMixing(const char* filePath, bool loopback, bool replace, int cycle) override;
				//virtual int startAudioMixing(const char* filePath, bool loopback, bool replace, int cycle, int startPos) override;
				...
				//virtual int adjustLoopbackRecordingVolume(int volume) override;
				...
				//virtual int addPublishStreamUrl(const char* url, bool transcodingEnabled) override;
//				virtual int removePublishStreamUrl(const char* url) override;
				//virtual int setLiveTranscoding(const LiveTranscoding& transcoding) override;
				...
				//virtual int pushDirectCdnStreamingCustomVideoFrame(media::base::ExternalVideoFrame* frame) override;
				//virtual int switchChannel(const char* token, const char* channel) override;
				...
				//virtual int enableFishCorrection(bool enabled, const FishCorrectionParams& params) override;
//				virtual int setAdvancedAudioOptions(media::base::AdvancedAudioOptions& options) override;
				...
				virtual int setAudioProfile(agora::rtc::AUDIO_PROFILE_TYPE profile, agora::rtc::AUDIO_SCENARIO_TYPE scenario);
				...
				//virtual int addPublishStreamUrlEx(const char* url, bool transcodingEnabled, const RtcConnection& connection) override;
				...
				int setAdvancedAudioOptions(AdvancedAudioOptions& options) override;
