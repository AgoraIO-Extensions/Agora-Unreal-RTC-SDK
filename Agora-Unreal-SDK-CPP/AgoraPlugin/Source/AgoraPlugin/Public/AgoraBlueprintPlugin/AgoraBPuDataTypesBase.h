...
enum class EUABT_LASTMILE_PROBE_RESULT_STATE :uint8 {
	...
	INVALID_OPT_BPGEN_NULL = 0 UMETA(Hidden, DisplayName = "AGORA NULL VALUE"),
	/**
...
#pragma region UtilityEnumConvert
...
namespace agora {
	namespace rtc {
		namespace ue {
			...
			class UABTEnum{
				public:
					// Method01: ToRawValue (convert [UEEnum] to [RawEnum])

					// Method02: WrapWithUE (convert [RawEnum] to [UEEnum])

					// For Code Snippet
					static inline void ToRawValue() {}
					static inline void WrapWithUE() {}
	...
	(EUABT_CAPTURE_BRIGHTNESS_LEVEL_TYPE,agora::rtc::CAPTURE_BRIGHTNESS_LEVEL_TYPE,
				...
				GEN_UABTFUNC_SIGNATURE_ENUMCONVERSION_3_ENTRIES(EUABT_HEADPHONE_EQUALIZER_PRESET, agora::rtc::HEADPHONE_EQUALIZER_PRESET,
						...
						HEADPHONE_EQUALIZER_OVEREAR,
						HEADPHONE_EQUALIZER_INEAR)									GEN_UABTFUNC_SIGNATURE_ENUMCONVERSION_2_ENTRIES(EUABT_FeatureType, agora::rtc::FeatureType,
...
#pragma endregion UtilityEnumConvert