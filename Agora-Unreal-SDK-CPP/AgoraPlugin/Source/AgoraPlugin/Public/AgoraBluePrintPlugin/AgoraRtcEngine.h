...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
		int PreloadChannel(FString token, FString channelId, int64 uid);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
		int PreloadChannelWithUserAccount(FString token, FString channelId, FString userAccount);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
		int UpdatePreloadChannelToken(FString token);
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
	...
	UFUNCTION(BlueprintCallable, Category = "Agora|RtcEngineProxy")
		int SetPublishAudioFrameParameters(int sampleRate, int channel,int samplesPerCall);
