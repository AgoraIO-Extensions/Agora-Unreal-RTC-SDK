...
module.exports = {
  ...
  'agora::rtc::IRtcEngine.getVersion': {
    name: 'agora::rtc::SDKBuildInfo',
    source: 'agora::rtc::SDKBuildInfo*',
    kind: SimpleTypeKind.pointer_t,
    is_const: false,
    is_builtin_type: false,
  },
  'agora::rtc::IAudioDeviceManager.getPlaybackDeviceInfo': {
    name: 'agora::rtc::AudioDeviceInfo',
    source: 'agora::rtc::AudioDeviceInfo*',
    kind: SimpleTypeKind.pointer_t,
    is_const: false,
    is_builtin_type: false,
  },
  ...
  'agora::rtc::IVideoDeviceManager.enumerateVideoDevices': {
    name: 'agora::rtc::VideoDeviceInfo',
    source: 'agora::rtc::VideoDeviceInfo*',
    kind: SimpleTypeKind.array_t,
    is_const: false,
    is_builtin_type: false,
  },
